					...
					<div class="team_slider">
						<div class="item">
							<div class="team_member style2 text-center">
								<div class="instructor_col">
									<div class="thumb">
										<img class="img-fluid img-rounded-circle" src="<?= Url::base()?>/images/team/6.png" alt="6.png">
									</div>
									<div class="details">
						...
						<div class="item">
							<div class="team_member style2 text-center">
								<div class="instructor_col">
									<div class="thumb">
										<img class="img-fluid img-rounded-circle" src="<?= Url::base()?>/images/team/7.png" alt="7.png">
									</div>
									<div class="details">
										<h4>Anna Richard</h4>
										<p>CSS, HTML</p>
						...
						<div class="item">
							<div class="team_member style2 text-center">
								<div class="instructor_col">
									<div class="thumb">
										<img class="img-fluid img-rounded-circle" src="<?= Url::base()?>/images/team/8.png" alt="8.png">
									</div>
									<div class="details">
						...
						<div class="item">
							<div class="team_member style2 text-center">
								<div class="instructor_col">
									<div class="thumb">
										<img class="img-fluid img-rounded-circle" src="<?= Url::base()?>/images/team/9.png" alt="9.png">
									</div>
									<div class="details">
										<h4>Kristen Pala</h4>
						...
						<div class="item">
							<div class="team_member style2 text-center">
								<div class="instructor_col">
									<div class="thumb">
										<img class="img-fluid img-rounded-circle" src="<?= Url::base()?>/images/team/10.png" alt="10.png">
									</div>
									<div class="details">
										<h4>Jill Poye</h4>

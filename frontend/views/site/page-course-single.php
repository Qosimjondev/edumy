			...
			<div class="row">
									...
									<div class="cs_ins_container">
										<div class="cs_instructor">
											<ul class="cs_instrct_list float-left mb0">
												<li class="list-inline-item"><img class="thumb" src="<?= Url::base()?>/images/team/4.png" alt="4.png"></li>
								...
								<div class="cs_row_four">
									<div class="about_ins_container">
										...
										<div class="about_ins_info">
											<div class="thumb"><img src="<?= Url::base()?>/images/team/6.png" alt="6.png"></div>
										</div>
										<div class="details">
									...
									<div class="sfeedbacks">
										...
										<div class="mbp_pagination_comments">
											<div class="mbp_first media csv1">
												<img src="<?= Url::base()?>/images/resource/review1.png" class="mr-3" alt="review1.png">
												<div class="media-body">
												    ...
												    <div class="mbp_sub media csv1">
												    	<a href="#"><img src="<?= Url::base()?>/images/resource/review1.png" class="mr-3" alt="review1.png"></a>
												        <div class="media-body">
											...
											<div class="mbp_second media csv1">
												<img src="<?= Url::base()?>/images/resource/review1.png" class="align-self-start mr-3" alt="review1.png">
												<div class="media-body">
											    	<h4 class="sub_title mt-0">Warren Bethell
														<span class="sspd_review float-right">
															<ul>
				...
				<div class="col-lg-4 col-xl-3">
					...
					<div class="selected_filter_widget style2">
						<span class="float-left"><img class="mr20" src="<?= Url::base()?>/images/resource/2.png" alt="2.png"></span>
